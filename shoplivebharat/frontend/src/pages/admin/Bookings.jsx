...
import { Search, Filter, X, Edit2, Trash2, Eye, Download } from "lucide-react";
...
function BookingRow({ booking, onEdit, onDelete, formatPrice }) {
    const slotDate = new Date(`${booking.date}T${booking.time}`);
    ...
    return (
        <tr className="border-b border-line-soft hover:bg-gray-50 transition">
            <td className="px-6 py-4 text-sm text-espresso font-medium">{booking.id}</td>
            ...
            <td className="px-6 py-4 text-sm text-espresso">{booking.shopName}</td>
            <td className="px-6 py-4 text-sm text-espresso">
                {new Date(booking.date).toLocaleDateString()}
            </td>
            <td className="px-6 py-4 text-sm text-maroon font-bold">{formatPrice(booking.price)}</td>
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {filteredBookings.length > 0 ? (
                                ...
                                <tr>
                                    <td colSpan="9" className="px-6 py-8 text-center text-espresso/60">
                                        No bookings found
                                    </td>
                                </tr>
                            )}
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-espresso/40 backdrop-blur-sm">
                    <div className="bg-white rounded-lg max-w-md w-full p-8 shadow-2xl">
                        ...
                        <div className="mb-6">
                            ...
                            <p className="font-semibold text-espresso">{selectedBooking.id}</p>
                        </div>
