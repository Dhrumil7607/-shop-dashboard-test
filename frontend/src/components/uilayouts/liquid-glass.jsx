// @ts-nocheck
// liquid-glass — from uilayouts, adapted for this CRA project:
//   • import path uses the installed `framer-motion` (not `motion/react`)
//   • lives under src/ so the `@/` alias resolves
